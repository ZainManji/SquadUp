//
//  GoingPeopleTableViewController.swift
//  Squad Up
//
...
class GoingPeopleTableViewController: UITableViewController, UIGestureRecognizerDelegate {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if (self.profilePics.objectForKey(userId) != nil) {
            ...
            cell.goingProfilePic.image = pic.image
            //cell.goingProfilePic.frame = CGRect(x: 15, y: 30, width: 30, height: 30)
            cell.goingProfilePic.layer.cornerRadius = cell.goingProfilePic.frame.size.width / 2
            cell.goingProfilePic.clipsToBounds = true
        }

                
        // Configure the cell.
        cell.goingFriendLabel.text = sortedValuesArray[indexPath.row] as? String
