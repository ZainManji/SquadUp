//
//  InvitedPeopleTableViewController.swift
//  Squad Up
//
...
class InvitedPeopleTableViewController: UITableViewController, UIGestureRecognizerDelegate {
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        if (self.invitedPeople.count == 0) {
            ...
            label.text = "No one else is invited"
    ...
    override func viewDidLoad() {
        ...
        for (key, value) in invitedPeople {
    ...
    override func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return self.invitedPeople.count
    }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if (self.profilePics.objectForKey(userId) != nil) {
            ...
            cell.invitedProfilePic.image = pic.image
            //cell.invitedProfilePic.frame = CGRect(x: 15, y: 30, width: 30, height: 30)
            cell.invitedProfilePic.layer.cornerRadius = cell.invitedProfilePic.frame.size.width / 2
            cell.invitedProfilePic.clipsToBounds = true
        }
        
        // Configure the cell.
        cell.invitedFriendLabel.text = sortedValuesArray[indexPath.row] as? String
